package locker_project_package;
...
public class homepage1 {
	...
	public static void main(String[] args) {
		...
		System.out.println(" PHASE ONE PROJECT ");
		System.out.println("                     ");
		System.out.println("SUBMITTED BY  NIVYA SHAJI ");
		System.out.println("                           ");
		System.out.println();
		do {
		...
		try {
		File file = new 
		File("I:\\simplelearn\\" + filename + ".txt");
		...
		System.out.println(search_filename + "  file  is  found");
		flag_s = 1;
		}
		}
		}
